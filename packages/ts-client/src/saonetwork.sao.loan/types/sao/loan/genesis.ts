...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, loanPool: undefined };
}
...
export const GenesisState = {
  encode(message: GenesisState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.loanPool !== undefined) {
      LoanPool.encode(message.loanPool, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      loanPool: isSet(object.loanPool) ? LoanPool.fromJSON(object.loanPool) : undefined,
    };
  },
