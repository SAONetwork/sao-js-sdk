...
export interface Pool {
  ...
  nextRewardPerBlock: DecCoin | undefined;
  totalStorage: number;
  rewardedBlockCount: number;
}
...
export const Pool = {
  encode(message: Pool, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.nextRewardPerBlock !== undefined) {
      DecCoin.encode(message.nextRewardPerBlock, writer.uint32(50).fork()).ldelim();
    }
    if (message.totalStorage !== 0) {
      writer.uint32(56).int64(message.totalStorage);
    }
    if (message.rewardedBlockCount !== 0) {
      writer.uint32(64).int64(message.rewardedBlockCount);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5:
          ...
          break;
        case 6:
          message.nextRewardPerBlock = DecCoin.decode(reader, reader.uint32());
          break;
        case 7:
          message.totalStorage = longToNumber(reader.int64() as Long);
          break;
        case 8:
          message.rewardedBlockCount = longToNumber(reader.int64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): Pool {
    return {
      ...
      nextRewardPerBlock: isSet(object.nextRewardPerBlock) ? DecCoin.fromJSON(object.nextRewardPerBlock) : undefined,
      totalStorage: isSet(object.totalStorage) ? Number(object.totalStorage) : 0,
      rewardedBlockCount: isSet(object.rewardedBlockCount) ? Number(object.rewardedBlockCount) : 0,
    };
  },
  ...
  toJSON(message: Pool): unknown {
    ...
    message.nextRewardPerBlock !== undefined
      && (obj.nextRewardPerBlock = message.nextRewardPerBlock ? DecCoin.toJSON(message.nextRewardPerBlock) : undefined);
    message.totalStorage !== undefined && (obj.totalStorage = Math.round(message.totalStorage));
    message.rewardedBlockCount !== undefined && (obj.rewardedBlockCount = Math.round(message.rewardedBlockCount));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Pool>, I>>(object: I): Pool {
    ...
    message.rewardPerBlock = (object.rewardPerBlock !== undefined && object.rewardPerBlock !== null)
      ...
      : undefined;
    message.nextRewardPerBlock = (object.nextRewardPerBlock !== undefined && object.nextRewardPerBlock !== null)
      ? DecCoin.fromPartial(object.nextRewardPerBlock)
      : undefined;
    message.totalStorage = object.totalStorage ?? 0;
    message.rewardedBlockCount = object.rewardedBlockCount ?? 0;
    return message;
  },
};
