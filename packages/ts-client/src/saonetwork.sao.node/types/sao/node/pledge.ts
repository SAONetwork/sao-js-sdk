...
export interface Pledge {
  ...
  totalShardPledged: Coin | undefined;
...
export const Pledge = {
  encode(message: Pledge, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.totalStoragePledged !== undefined) {
      Coin.encode(message.totalStoragePledged, writer.uint32(18).fork()).ldelim();
    }
    if (message.totalShardPledged !== undefined) {
      Coin.encode(message.totalShardPledged, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.usedStorage !== 0) {
      writer.uint32(56).int64(message.usedStorage);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.totalShardPledged = Coin.decode(reader, reader.uint32());
          break;
        case 4:
        ...
        case 6:
          ...
          break;
        case 7:
          message.usedStorage = longToNumber(reader.int64() as Long);
          break;
        default:
  ...
  fromJSON(object: any): Pledge {
    return {
      ...
      totalShardPledged: isSet(object.totalShardPledged) ? Coin.fromJSON(object.totalShardPledged) : undefined,
      ...
      usedStorage: isSet(object.usedStorage) ? Number(object.usedStorage) : 0,
    };
  },
  ...
  toJSON(message: Pledge): unknown {
    ...
    message.totalShardPledged !== undefined
      && (obj.totalShardPledged = message.totalShardPledged ? Coin.toJSON(message.totalShardPledged) : undefined);
    ...
    message.usedStorage !== undefined && (obj.usedStorage = Math.round(message.usedStorage));
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Pledge>, I>>(object: I): Pledge {
    ...
    message.totalStoragePledged = (object.totalStoragePledged !== undefined && object.totalStoragePledged !== null)
      ...
      : undefined;
    message.totalShardPledged = (object.totalShardPledged !== undefined && object.totalShardPledged !== null)
      ? Coin.fromPartial(object.totalShardPledged)
      : undefined;
    ...
    message.usedStorage = object.usedStorage ?? 0;
    return message;
  },
};
