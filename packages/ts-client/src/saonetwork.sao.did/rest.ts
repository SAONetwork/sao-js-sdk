...
export interface DidDid {
  accountId?: string;
  did?: string;
}

export interface DidDidBalances {
  did?: string;
...
export type DidMsgUpdateResponse = object;
...
export interface DidQueryAllAccountIdResponse {
  accountId?: DidAccountId[];
...
export interface DidQueryAllDidBalancesResponse {
  didBalances?: DidDidBalances[];
...
export interface DidQueryAllDidResponse {
  did?: DidDid[];
...
export interface DidQueryAllKidResponse {
  kid?: DidKid[];
...
export interface DidQueryGetAccountIdResponse {
  accountId?: DidAccountId;
}
...
export interface DidQueryGetDidBalancesResponse {
  didBalances?: DidDidBalances;
}

export interface DidQueryGetDidResponse {
  did?: DidDid;
}

export interface DidQueryGetKidResponse {
  kid?: DidKid;
}
...
export type DidQueryValidateDidResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryAccountIdAll
   * @summary Queries a list of AccountId items.
   * @request GET:/SaoNetwork/sao/did/account_id
   */
  queryAccountIdAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DidQueryAllAccountIdResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/account_id`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryAccountId
   * @summary Queries a AccountId by index.
   * @request GET:/SaoNetwork/sao/did/account_id/{accountDid}
   */
  queryAccountId = (accountDid: string, params: RequestParams = {}) =>
    this.request<DidQueryGetAccountIdResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/account_id/${accountDid}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/SaoNetwork/sao/did/did
   */
  queryDidAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DidQueryAllDidResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/did`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryDid
   * @summary Queries a Did by index.
   * @request GET:/SaoNetwork/sao/did/did/{accountId}
   */
  queryDid = (accountId: string, params: RequestParams = {}) =>
    this.request<DidQueryGetDidResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/did/${accountId}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   *
   * @tags Query
   * @name QueryDidBalancesAll
   * @summary Queries a list of DidBalances items.
   * @request GET:/SaoNetwork/sao/did/did_balances
   */
  queryDidBalancesAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DidQueryAllDidBalancesResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/did_balances`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryDidBalances
   * @summary Queries a DidBalances by index.
   * @request GET:/SaoNetwork/sao/did/did_balances/{did}
   */
  queryDidBalances = (did: string, params: RequestParams = {}) =>
    this.request<DidQueryGetDidBalancesResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/did_balances/${did}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryKidAll
   * @summary Queries a list of Kid items.
   * @request GET:/SaoNetwork/sao/did/kid
   */
  queryKidAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<DidQueryAllKidResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/kid`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @tags Query
   * @name QueryKid
   * @summary Queries a Kid by index.
   * @request GET:/SaoNetwork/sao/did/kid/{address}
   */
  queryKid = (address: string, params: RequestParams = {}) =>
    this.request<DidQueryGetKidResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/kid/${address}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   *
   * @tags Query
   * @name QueryValidateDid
   * @summary Queries a list of ValidateDid items.
   * @request GET:/SaoNetwork/sao/did/validate_did/{did}
   */
  queryValidateDid = (did: string, params: RequestParams = {}) =>
    this.request<DidQueryValidateDidResponse, RpcStatus>({
      path: `/SaoNetwork/sao/did/validate_did/${did}`,
      method: "GET",
      format: "json",
      ...params,
    });
