...
export const QueryProposal = {
  encode(message: QueryProposal, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.keywordType !== 0) {
      writer.uint32(32).uint32(message.keywordType);
    }
    ...
    if (message.dataOwner !== "") {
      writer.uint32(74).string(message.dataOwner);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.keywordType = reader.uint32();
          break;
        case 5:
  ...
  fromJSON(object: any): QueryProposal {
    return {
      ...
      keywordType: isSet(object.keywordType) ? Number(object.keywordType) : 0,
      ...
      dataOwner: isSet(object.dataOwner) ? String(object.dataOwner) : "",
    };
  },
  ...
  toJSON(message: QueryProposal): unknown {
    ...
    message.keywordType !== undefined && (obj.keywordType = Math.round(message.keywordType));
    ...
    message.dataOwner !== undefined && (obj.dataOwner = message.dataOwner);
    return obj;
  },
